    ...
    server.registerTool(
        'describe_table',
        {
            ...
            description: [
                ...
                'data actually looks like — including which years and formats it really covers.',
                'A `note` appears whenever something needs explaining (a view\'s missing sample',
                'rows, a source that could not be read, a truncated cell) and is absent otherwise.',
